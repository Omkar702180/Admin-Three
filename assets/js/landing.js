...
function switcherClick() {
  ...
  let lightThemeVar = lightBtn.addEventListener("click", () => {
    lightFn();
    localStorage.setItem("WebDeveloperslandingHeader", "light");
    localStorage.setItem("WebDeveloperslandingMenu", "light");
  });
  /* Light Layout End */
  ...
  let darkThemeVar = darkBtn.addEventListener("click", () => {
    darkFn();
    localStorage.setItem("WebDeveloperslandingMenu", "dark");
    localStorage.setItem("WebDeveloperslandingHeader", "dark");
  });
  /* Dark Layout End */
...
function checkOptions() {
  ...
  // light
  if (localStorage.getItem("WebDeveloperslighttheme")) {
    document.querySelector("#switcher-light-theme").checked = true;
  }
  ...
  if (localStorage.getItem("WebDevelopersltr")) {
    document.querySelector("#switcher-ltr").checked = true;
  }
}
