...
if (localStorage.WebDeveloperslayout == "horizontal") {
  document.querySelector("html").setAttribute("data-nav-layout", "horizontal");

}

if(localStorage.WebDeveloperslighttheme && localStorage.WebDeveloperslayout == 'horizontal'){
...
if (localStorage.WebDevelopersMenu == "color") {
  document.querySelector("html").setAttribute("data-menu-styles", "color");
}
if (localStorage.WebDevelopersHeader == "color") {
  document.querySelector("html").setAttribute("data-header-styles", "color");
}
if (localStorage.WebDevelopersMenu == "gradient") {
  document.querySelector("html").setAttribute("data-menu-styles", "gradient");
}
if (localStorage.WebDevelopersHeader == "gradient") {
  document.querySelector("html").setAttribute("data-header-styles", "gradient");
}
if (localStorage.WebDevelopersMenu == "dark") {
  document.querySelector("html").setAttribute("data-menu-styles", "dark");
}
if (localStorage.WebDevelopersHeader == "dark") {
  document.querySelector("html").setAttribute("data-header-styles", "dark");
}
if (localStorage.WebDevelopersMenu == "light") {
  document.querySelector("html").setAttribute("data-menu-styles", "light");
}
if (localStorage.WebDevelopersHeader == "light") {
  document.querySelector("html").setAttribute("data-header-styles", "light");
}
if (localStorage.WebDevelopersMenu == "transparent") {
  document
    .querySelector("html")
    .setAttribute("data-menu-styles", "transparent");
}
if (localStorage.WebDevelopersHeader == "transparent") {
  document
    .querySelector("html")
...
if (localStorage.WebDevelopersverticalstyles == "closed") {
  document.querySelector("html").setAttribute("data-vertical-style", "closed");
}
if (localStorage.WebDevelopersverticalstyles == "icontext") {
  document
    .querySelector("html")
    .setAttribute("data-vertical-style", "icontext");
}
if (localStorage.WebDevelopersverticalstyles == "overlay") {
  document.querySelector("html").setAttribute("data-vertical-style", "overlay");
}
if (localStorage.WebDevelopersverticalstyles == "detached") {
  document
    .querySelector("html")
    .setAttribute("data-vertical-style", "detached");
}
if (localStorage.WebDevelopersverticalstyles == "doublemenu") {
  document
    .querySelector("html")
